        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
          ...
          <div className="flex flex-col gap-4 max-w-xs">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 border border-white/30 rounded-full flex items-center justify-center flex-shrink-0">
                <span className="text-white text-xs font-bold" style={{ fontFamily: 'var(--font-sans)' }}>IITR</span>
              </div>
